...
<div class="container-fluid">
    <div class="row align-items-center">
        ...
        <div class="col-6 dashboard-title text-end">
            <button data-bs-toggle="modal" data-bs-target="#permissionAddModal" class="btn-outline">+ Add Permissions</button>
        </div>
    </div>
</div>
                                ...
                                <table class="table table-borderless align-middle text-center dashboardTable customTable" id="PermissionGroupTable">
                                    ...
                                    <tbody>
                                        ...
                                        <td class="actionBtn text-center">
                                            <button onclick='viewPermission({{ $permission->id}})'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                            ...
                                            <button onclick='editPermission({{  $permission->id }})'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                            ...
                                            </button> <button onclick='deletePermission({{ $permission->id }})'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 form-input">
                            ...
                            <input class="form-control" type="text" placeholder="Add Permission" name="name">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 form-input">
                            ...
                            <select name="group_name" id="group_name" class="form-control" >
								<option disabled>Select Permission Group</option>
                                @if(!empty($Permission_group))
                                @foreach($Permission_group as $permission)
                                    <option value="{{$permission->name}}">{{$permission->name}}</option>
                                @endforeach
                        ...
                        <div class="col-12 form-input">
                            <label for="name">Permission</label>
                            <input class="form-control" type="text" placeholder="Add Permission" id="name" name="name">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<script>
    ...
    var config = {
        routes: {
            ...
            update: "{!! route('permissions.update') !!}",
            delete: "{!! route('permissions.destroy') !!}",
        }
    };
    ...
    $(document).ready(function() {
        $("#permissionAddForm").validate({
            ...
            messages: {
                name: {
                    required: 'Please Insert Permission',
                },
                group_name: {
            ...
            success: function(response) {
                ...
                if (response.success == true) {
                    ...
                    var trDOM = idea_table.row.add([
                        ...
                        `
                        <button  onclick='viewPermission(${response.data.id})'><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <button  onclick='editPermission(${response.data.id})'><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" fill="none" viewBox="0 0 24 24">
                                <path fill="#BDBDBD"
                        ...
                        <button onclick='deletePermission(${response.data.id})'><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" fill="none" viewBox="0 0 24 24">
                                <path fill="#EB5757"
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success == true) {
                    ...
                    $('#v_group_name').text(response.data.group_name);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success == true) {
                        ...
                        $('.item' + response.data.id).replaceWith(`<tr class='item${response.data.id}'><td>${response.data.name}</td><td>${response.data.group_name}</td><td class="actionBtn text-center"> <button  onclick='viewPermission(${response.data.id})'><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" fill="none" viewBox="0 0 24 24">
                                <path fill="#BDBDBD"
                                    d="M21.92 11.6C19.9 6.91 16.1 4 12 4s-7.9 2.91-9.92 7.6a1 1 0 000 .8C4.1 17.09 7.9 20 12 20s7.9-2.91 9.92-7.6a1 1 0 000-.8zM12 18c-3.17 0-6.17-2.29-7.9-6C5.83 8.29 8.83 6 12 6s6.17 2.29 7.9 6c-1.73 3.71-4.73 6-7.9 6zm0-10a4 4 0 100 8 4 4 0 000-8zm0 6a2 2 0 110-4 2 2 0 010 4z" />
                            </svg>
